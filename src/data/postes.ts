...
export const postes: Poste[] = [
  {
    ...
    slug: "badan",
    nom: "Badan",
    type_poste: "Poste à leviers individuels",
    lignes: ["750000"],
    ...
    annuaire: [
      ...
      {
        titre: "Entreprises ferroviaires (ExF)",
        contacts: [
    ...
    circuits_voie: [
      {
        designation: "C12/V2",
        voie: "Voie 2 Badan–Chasse",
        delai_max: "72h",
        note: "Passage obligatoire toutes les 72h maximum",
      },
      {
        designation: "C55/V1",
        voie: "Voie 1 Badan–Chasse",
        delai_max: "72h",
        note: "Passage obligatoire toutes les 72h maximum",
      },
    ],
    pn_sensibles: [
      {
        numero: "363",
        contact: "Gendarmerie Irigny",
        telephone: "04 78 50 30 33",
      },
      {
        numero: "361",
        contact: "—",
        note: "PN normalement fermé — portails cadenassés",
      },
    ],
    particularites: [
    ...
    procedures_cles: [
      {
        titre: "Consigne UTIL",
        description: "Utilisation des installations de Badan P1",
        reference: "EIC RA DC07446",
      },
      {
        titre: "Organisation",
        description: "Organisation du poste Badan P1 et P2",
        reference: "EIC RA DC07294",
      },
      {
        titre: "Protection",
        description: "Mesures de protection Badan",
        reference: "EIC RA CM07371",
      },
      {
        titre: "Consigne bleue",
        description: "Consigne bleue Badan",
        reference: "EIC RA IN00600",
      },
      {
        titre: "Cessation de service Badan P2",
        description: "Procédure de cessation et reprise du service pour Badan P2",
        reference: "EIC RA DC07294",
      },
      {
        titre: "Cessation de service Badan P1",
        description: "Procédure de cessation et reprise du service pour Badan P1",
        reference: "EIC RA DC07292",
      },
    ],
    rex: [
  ...
  },
  {
    ...
    slug: "givors-canal",
    nom: "Givors Canal",
    type_poste: "PRS (Poste Tout Relais à Transit Souple)",
    lignes: ["750000", "800000", "906000"],
    ...
    circuits_voie: [
      {
        designation: "Zone Condrieu",
        voie: "IN-A, A-1S, 2S-A, A-2N",
        note: "Surveillance régulière obligatoire",
      },
      {
        designation: "Zone RACC",
        voie: "1CV-1V, 2V-2CV, 1V-2BC, 1B-2V",
        note: "Surveillance régulière obligatoire",
      },
      {
        designation: "C12/V2 — Zone Badan P1",
        voie: "Voie 2 Badan–Chasse",
        delai_max: "72h",
        note: "Passage obligatoire toutes les 72h maximum",
      },
      {
        designation: "C55/V1 — Zone Badan P1",
        voie: "Voie 1 Badan–Chasse",
        delai_max: "72h",
        note: "Passage obligatoire toutes les 72h maximum",
      },
    ...
    dbc: [
      {
        designation: "DBC Loire V1",
        voie: "Loire V1",
        note: "Surveillance obligatoire",
      },
      {
        designation: "DBC Loire V2",
        voie: "Loire V2",
        note: "Surveillance obligatoire",
      },
    ],
    pn_sensibles: [
      {
        numero: "16, 17, 18",
        contact: "Gendarmerie Ampuis",
        note: "Avis gendarmerie obligatoire en cas d'incident",
      },
      {
        numero: "29",
        contact: "Gendarmerie Serrières",
        note: "Avis gendarmerie obligatoire en cas d'incident",
      },
      {
        numero: "363",
    ...
    procedures_cles: [
      {
        titre: "Consigne UTIL Givors Canal",
        description: "Utilisation des installations de Givors Canal",
        reference: "EIC RA DC07454",
      },
      {
        titre: "Consigne UTIL Badan",
        description: "Utilisation des installations de Badan P1",
        reference: "EIC RA DC07446",
      },
      {
      ...
      },
      {
        ...
        description: "Procédure de cessation et reprise du service pour Givors Canal",
        reference: "EIC RA DC07283",
      },
      {
        titre: "Erreur d'envoi Chasse → Racc Peyraud V1",
        description: "Circulation en provenance de Chasse vers GIV envoyée par erreur sur Raccordement Peyraud V1",
        reference: "Art 6 DC11683 / fiche 204 DC01560",
      },
      {
        titre: "Souterrains et passerelle",
        description: "Passerelle Irigny-Yvours, Souterrain Grigny-Le-Sablon, Souterrain Givors Ville",
  ...
  },
  {
    ...
    circuits_voie: [
      {
        designation: "Voie 1bis",
        note: "Circuit de voie local à surveiller",
      },
      {
        designation: "Voie 2bis",
        note: "Circuit de voie local à surveiller",
      },
      {
        designation: "Raccordement sud Peyraud",
        note: "Circuit de voie local à surveiller",
      },
    ],
    dbc: [
      {
        designation: "DBC Andance V2",
        voie: "Voie 2 — section Andance",
        note: "Surveillance obligatoire",
      },
      {
        designation: "DBC Limony V1",
        voie: "Voie 1 — section Limony",
        note: "Surveillance obligatoire",
      },
    ],
    pn_sensibles: [
    ...
    procedures_cles: [
      {
        titre: "TCO hors service",
        description: "En cas de défaillance du TCO, appliquer la procédure spécifique",
        reference: "Fiche 313 DC01560",
      },
      {
      ...
      {
        titre: "Surveillance des trains en marche",
        description: "L'AC de Peyraud P1 dispose des boutons DAA V1 C 578,7 et DAA V2 C 571,5 sur la table de commande, à utiliser lors de la détection d'une anomalie.",
        reference: "DC01503 / DC01505 art. 2.1.8",
      },
      {
        titre: "Dérangements — Consigne UTIL",
        description: "Se référer à la consigne UTIL pour la gestion des cas de dérangements.",
      },
    ],
    rex: [
